...
export class QuestionPoll extends Component {
  static propTypes = {
    ...
    onSaveQuestionAnswer: PropTypes.func.isRequired,
  ...
  handleSubmit = e => {
    e.preventDefault();
    if (this.state.value !== '') {
      const { authUser, question, onSaveQuestionAnswer } = this.props;
      onSaveQuestionAnswer(authUser, question.id, this.state.value);
    }
  };
