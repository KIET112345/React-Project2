      ...
      <Fragment>
        {leaderboardData.map((user, idx) => (
          <Segment.Group key = {user.id}>
            ...
            <Grid divided padded>
              <Grid.Row>
                <Grid.Column width = {2} verticalAlign = "middle" style= {{height: 85+ '%'}}>
                <Image src={user.avatarURL} style= {{borderRadius: 50+ '%',height: 100+ '%'}}/>
                </Grid.Column>
                ...
                <Grid.Column width = {8}>
                  ...
                  <Grid>
                    ...
                    <Grid.Column width = {4}><b>{user.answerCount}</b></Grid.Column>
                  </Grid>
                  <Divider />
                  <Grid>
                    <Grid.Column width = {12}>Created questions</Grid.Column>
                    <Grid.Column width = {4}><b>{user.questionCount}</b></Grid.Column>
                  </Grid>
                </Grid.Column>
